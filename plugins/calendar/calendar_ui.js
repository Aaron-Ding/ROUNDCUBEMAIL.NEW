...
function rcube_calendar_ui(settings)
{
    ...
    var event_show_dialog = function(event, ev, temp)
    {
      ...
      $('#event-rsvp')['hide']();
      var calendar = is_attendee(event) && event.calendar && me.calendars[event.calendar] ? me.calendars[event.calendar] : { editable:false, rights:'lrs' };
      ...
      //if (calendar.attendees && event.attendees) {
        ...
        if (html && (event.attendees.length > 0 || !organizer)) {
