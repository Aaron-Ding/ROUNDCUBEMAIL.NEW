...
$config['apc_max_allowed_packet'] = '102400M';
...
$config['product_name'] = 'Sinorama Webmail';

// Add this user-agent to message headers when sending
$config['useragent'] = 'Sinorama Webmail/'.RCMAIL_VERSION;
...
$config['plugins'] = array('xskin','managesieve','password','html5_notifier','filters','libcalendaring','calendar','tasklist','roundrive','rcp_public_mailbox','rcp_message','customizr','custom_logo','globaladdressbook','message_label','image_paster','contextmenu','automatic_addressbook');


// define a custom watermark image (relative or absolute URL)
$config['custom_watermark_image'] = 'plugins/customizr/watermark.jpg';
...
$config['custom_favicon'] = 'plugins/customizr/favicon.ico';

// defines a custom CSS file which is added to every page
$config['custom_stylesheet'] = '';

$rcmail_config['common_logo_url'] = 'plugins/custom_logo/roundcube_logo.png';
...
#$config['skin'] = 'outlook alpha classic droid icloud larry litecube litecube-f w21';
$config['skin'] = 'outlook';
...
$config['license_key'] = 'RCS-RGoPv3LTxJkm';

$rcmail_config['show_drive_task'] = true;

// Configuration WebDAV
$rcmail_config['driver_webdav_url_base'] = 'http://cloud.sinoramagroup.com/';
$rcmail_config['driver_webdav_url'] = $rcmail_config['driver_webdav_url_base'] . 'remote.php/webdav/';

// Prefix ex for owncloud : /remote.php/webdav/
$rcmail_config['driver_webdav_prefix'] = '/remote.php/webdav/';

$rcmail_config['max_message_size'] = "7MB";


// below is for global address book
...
$config['globaladdressbook_admin'] = 'aaron@sinoramagroup.com';
...
$config['resources_calendar']=array(
    array(name=>"Montreal 4th floor meeting room",email=>"meeting_room_4f@sinoramagroup.com",domain=>array("sinoramagroup.com")),
    array(name=>"Montreal bus office meeting room",email=>"meeting_room_bus@sinoramagroup.com",domain=>array("sinoramagroup.com")),
    array(name=>"Montreal 5th floor meeting room",email=>"meeting_room_5f@sinoramagroup.com",domain=>array("sinoramagroup.com")),
);
$config['password_query']="update vmail.mailbox set password= %c where username= %u ";
$config["owncloud_public_account_password"]=array(
        "info@sinoramaholidays.com"=>"sino3388",
        "info@sinoramavancouver.com"=>"sino3388"
);
